...
public:
    ...
    // Operadores de E/S, extracción e inserción respectivamente.
    friend std::ostream& operator << (std::ostream& os, const Fecha& f1);
    friend std::istream& operator >> (std::istream& is, Fecha& f1);
